...
var thumbChanger = function thumbChanger(cssSelector) {
    _classCallCheck(this, thumbChanger);
    ...
    function onThumbFirst() {
        var allClasses = displayImg.classList;
...
exports.thumbChanger = thumbChanger;
...
var ACTIVE_SLIDE_CSS_CLASS = '.board_block_active';

var slideBoard = function () {
    function slideBoard(cssSelector) {
        _classCallCheck(this, slideBoard);
    ...
    _createClass(slideBoard, [{
        key: 'enableSlides',
        value: function enableSlides() {
            var slide = this.slide[this.activeSlideIndex];
            slide.classList.add(ACTIVE_SLIDE_CSS_CLASS);
        }
    }, {
        key: 'disableSlades',
        value: function disableSlades() {
